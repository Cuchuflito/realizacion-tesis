...
from tkinter import Frame, Canvas, Entry, Label, Button, StringVar, Radiobutton, NW
...
class ImageSegmentationApp:
    ...
    def show_segmented_image(self):
        img = Image.fromarray(self.displayed_image)
    ...
    def handle_click(self, event):
        ...
        self.paint_segment(event.x, event.y, chosen_color)
